...
function SiteRecruit_PageConfigurationBroker()
{
    ...
    this.m = [        
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-de.js', 1, [
        {'cookieName':'gssLANG','cookieValue':'de'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-de.js', 0, [
        {'language':'de'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-us.js', 1, [
        {'cookieName':'gssLANG','cookieValue':'en-us'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-us.js', 0, [
        {'language':'en-us'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-fr.js', 1, [
        {'cookieName':'gssLANG','cookieValue':'fr'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-fr.js', 0, [
        {'language':'fr'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-ja.js', 1, [
        {'cookieName':'gssLANG','cookieValue':'ja'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-ja.js', 0, [
        {'language':'ja'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-nl.js', 1, [
        {'cookieName':'gssLANG','cookieValue':'nl'},
    ]],
    ['', '/library/svy/SiteRecruit_PageConfiguration_3332mt-nl.js', 0, [
        {'language':'nl'},
    ]],
    ];
