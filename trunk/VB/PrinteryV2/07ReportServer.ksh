...
# Warning: The current version does not check the validity of these
#

# Check of existence of all parameters
#if [ $# -ne 8 ]
#then
#	echo "Some parameter are missing!"
#	echo "Call: $0 $*"
#	echo "Syntax: RLPReportSvr.ksh <ReportName> <OutputType>\c"
#	echo " <OutputPath> <Printer> <DbType> <User> <Password> <Parameter01>"
#	exit 1
#fi
...
then
	...
	cd $BALI_reports/tmp/
	$DISTILLER -quiet -compatlevel 3.0 -pagesize 21.0 29.7 cm -resolution 600 $1.ps
	chmod 440 $1.pdf
